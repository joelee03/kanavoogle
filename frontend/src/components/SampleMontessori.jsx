...
const SampleMontessori = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      const section1Doc = await getDoc(doc(db, 'projects', 'm1'));
      const section2Doc = await getDoc(doc(db, 'projects', 'm2'));
      const section3Doc = await getDoc(doc(db, 'projects', 'm3'));
        ...
        <div className="admin-controls p-4 bg-gray-100 mt-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('m1', section1)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 1
            </button>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('m2', section2)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 2
            </button>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('m3', section3)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 3
            </button>
          </div>
        </div>
...
export default SampleMontessori;