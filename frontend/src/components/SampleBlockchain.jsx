...
const SampleBlockchain = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      const section1Doc = await getDoc(doc(db, 'projects', 'b1'));
      const section2Doc = await getDoc(doc(db, 'projects', 'b2'));
      const section3Doc = await getDoc(doc(db, 'projects', 'b3'));
        ...
        <div className="admin-controls p-4 bg-gray-100 mt-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('b1', section1)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 1
            </button>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('b2', section2)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 2
            </button>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border"
            />
            <button onClick={() => updateSection('b3', section3)} className="mt-2 p-2 bg-blue-500 text-white rounded">
              Save Section 3
            </button>
          </div>
        </div>
...
export default SampleBlockchain;